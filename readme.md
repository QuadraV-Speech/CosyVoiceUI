...
```bash
COSYVOICE_SERVER_PORT=10100
COSYVOICE_USE_SSL=false
COSYVOICE_RELOAD=false
COSYVOICE_LOG_LEVEL=INFO
COSYVOICE_LOG_FILE=tmp/server.log
COSYVOICE_BACKEND_SERVER_URL=http://127.0.0.1:18000
COSYVOICE_BACKEND_TIMEOUT_SECONDS=120
COSYVOICE_BACKEND_SEGMENT_WORKERS=1
COSYVOICE_TTS_CONCURRENCY_LIMIT=32
```
